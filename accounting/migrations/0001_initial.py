...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('account_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='accounting.account')),
                ('basic_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounting.basicaccount', verbose_name='basicaccount')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounting.moeinaccount', verbose_name='parent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moein_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounting.moeinaccount', verbose_name='moein account')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounting.tafsiliaccount', verbose_name='parent')),
            ],
            options={
