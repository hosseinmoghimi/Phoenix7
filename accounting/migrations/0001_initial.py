# Generated by Django 5.0.6 on 2024-10-06 14:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authentication', '0002_alter_profile_prefix'),
        ('core', '0001_initial'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(max_length=50, verbose_name='code')),
                ('type', models.CharField(choices=[('بستانکار', 'بستانکار'), ('فقط بستانکار', 'فقط بستانکار'), ('بدهکار', 'بدهکار'), ('فقط بدهکار', 'فقط بدهکار'), ('بدون کنترل', 'بدون کنترل')], max_length=50, verbose_name='ماهیت')),
                ('accounts', models.ManyToManyField(blank=True, to='accounting.account', verbose_name='accounts')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.profile', verbose_name='profile')),
                ('categories', models.ManyToManyField(blank=True, to='accounting.personcategory', verbose_name='categories')),
            ],
            options={
                'verbose_name': 'شخص',
